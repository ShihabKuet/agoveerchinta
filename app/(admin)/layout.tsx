...
import { PenSquare, FileText, Home, Settings } from 'lucide-react'
    ...
    <div className="min-h-screen bg-paper flex">
      ...
      <nav className="w-16 md:w-56 bg-[var(--color-ink)] text-white flex flex-col shrink-0">
        ...
        <div className="p-3 border-t border-white/10">
          <Link href="/" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-white/50 hover:text-white hover:bg-white/10 transition-colors">
